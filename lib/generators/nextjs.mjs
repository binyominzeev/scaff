...
export function generateNextjsProject(outDir, spec, warnings = []) {
  const { frontMatter, prismaBlock, pages, constraintsBlock, developmentOrderBlock, screens = [], navItems = [] } = spec;
  ...
  if (screens.length) {
    writeUiKit(outDir, { framework: "nextjs-app-router", navItems });
